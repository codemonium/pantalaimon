...
async def init(data_dir, server_conf, send_queue, recv_queue):
    ...
    app.add_routes(
        [
            ...
            web.get("/_matrix/client/r0/login/sso/redirect/oidc-{idp_id}", proxy.oidc),
            web.get("/_matrix/client/v3/login/sso/redirect/oidc-{idp_id}", proxy.oidc),
            web.get(
                "/_matrix/client/r0/rooms/{room_id}/initialSync", proxy.initialSync
            ),
            web.get(
                "/_matrix/client/v3/rooms/{room_id}/initialSync", proxy.initialSync
            ),
            ...
            web.put(
                ...
                proxy.forward_to_web_with_overridden_access_token,
            ),
            web.put(
